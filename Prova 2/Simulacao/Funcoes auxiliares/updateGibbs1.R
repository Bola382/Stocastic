# atualiza somente parametros que nao dependem da componente
...
updateGibbs1 = function(param,arg){
 paramnames = names(param)
 if(any(arg == paramnames[2:4])){return(param)}
 novo = switch(arg,
               prob = full_prob(param[["z"]]),
               alpha = full_alpha(param[["nu"]]),
               nu = full_nu(param[["prob"]],param[["beta"]],param[["tau2"]],param[["Delta"]],param[["alpha"]],param[["nu"]]),
